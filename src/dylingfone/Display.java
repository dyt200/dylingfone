...
/**
 * 
 * General class that displays the phone 
 * 
 * @author Dylan Thompson & Benjamin Pocklington
 *
 */
...
public class Display extends JFrame implements ActionListener {
	...
	/**
	 * Create's and display's the phones skeleton (i phone frame, home button and lock button)
	 * Added a drag listener to be able to move the phone around
	 */
...
/**
 *  Creates and displays a black panel when called
 *  Typically, when you press the lock button
 */
	...
	/**
	 * Creates and displays the lock screen when called
	 * Composition : Background image, a clock thatis called with generateClock(), 
	 * and an unlock button with a mouse listener for the animation
	 */
	...
	/**
	 * Generates the clock which calls setdate() (Gets the current time)
	 */
	...
	/**
	 * Gets the time every 100 milliseconds
	 */
	public void setdate() {
	...
	/**
	 *  Creates and display's the home screen with the contact app and the gallery app
	 */
	...
	/**
	 * Creates and display the contacts app. it uses the contacts class to get the contacts from the XML
	 */
	...
	/**
	 * 
	 * Creates and displays the contact clicked in contacts app
	 * 
	 * The contact picture is generated by  an id of a picture that is stored in the contact
	 * 
	 * @param id caught from the mouse listener in contacts 
	 */
	...
	/**
	 * 
	 * Creates and display the edit contact panel 
	 * 
	 * Save the modified info in the contact XML
	 * 
	 * @param id of the contact, caught from the mouse listener in the contact detail
	 */
	...
	/**
	 * 
	 * Creates and display's the add contact panel
	 * @param caughtContactImageID this is the id of the image seleted by the add image method
	 */
	...
	/**
	 * 
	 * Generates and displays a back panel when called 
	 * @param head is the title of the back panel (The name of the contact or description of the picture )
	 * @param id is the id of the element that is showed under the back panel
	 * @param type
	 */
...
//		  btnEditContact.setActionCommand("EditContact");
	...
	/**
	 * Generates the gallery with the object Gallery (That gets the info from the XML)
	 * @param contactID is used if we are editing a profile picture 
	 * @param isEditProfilePic is used to know if we are editing a profile picture 
	 */
	...
	/**
	 * 
	 * Creates and displays the detail of an image
	 * @param id is caught by the mouse listener in  the gallery
	 */
	...
	/**
	 * This is the action commands
	 * It is used to control the main panels and the basic phone operation, lock, go to home...
	 */
	 ...
	 * @param originHeight Is the img original Height
	 * @param originWidth Is the img original Width
	 * @param newWidth is the width fixed width desired
	 * @return returns the new height that respects the image ratio given the width
	 */
